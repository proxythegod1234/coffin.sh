...
var r=e,i=r.id?"#"+r.id:o(r)+(r.classList&&r.classList.value&&r.classList.value.trim()&&r.classList.value.trim().length?"."+r.classList.value.trim().replace(/\s+/g,"."):"");
...
name:e,value:void 0===t?-1:t,rating:"good",delta:0,entries:[],id:"v4-".concat(Date.now(),"-").concat(Math.floor(8999999999999*Math.random())+1e12),navigationType:i
}
...
var t=M[M.length-1],n=B.get(e.interactionId);
...
t||(t={
startTime:e.startTime,processingStart:e.processingStart,processingEnd:e.processingEnd,renderTime:n,entries:[e]
}
...
;
var n=l("TTFB"),i=v(e,n,re,t.reportAllChanges);
ie(function(){
var o=r();
...
if(G>=0&&G<Y-ce){
var e={
entryType:"first-input",name:$.type,target:$.target,cancelable:$.cancelable,startTime:$.timeStamp,processingStart:$.timeStamp+G
}
;
...
o&&(n={
largestShiftTarget:a(o.node),largestShiftTime:r.startTime,largestShiftValue:r.value,largestShiftSource:o,largestShiftEntry:r,loadState:i(r.startTime)
}
)
}
...
var n=function(e){
var t={
timeToFirstByte:0,firstByteToFCP:e.value,loadState:i(s())
}
;
if(e.entries.length){
var n=r(),o=e.entries[e.entries.length-1];
if(n){
var a=n.activationStart||0,c=Math.max(0,n.responseStart-a);
t={
timeToFirstByte:c,firstByteToFCP:e.value-c,loadState:i(e.entries[0].startTime),navigationEntry:n,fcpEntry:o
}
...
var n=function(e){
var t=e.entries[0],n={
eventTarget:a(t.target),eventType:t.name,eventTime:t.startTime,eventEntry:t,loadState:i(t.startTime)
}
;
return Object.assign(e,{
attribution:n
...
var n=function(e){
var t=e.entries[0],n=H.get(t),r=t.processingStart,o=n.processingEnd,c=n.entries.sort(function(e,t){
return e.processingStart-t.processingStart
}
),s=ee(t.startTime,o),u=e.entries.find(function(e){
return e.target
}
),f=u&&u.target||K.get(t.interactionId),l=[t.startTime+t.duration,o].concat(s.map(function(e){
return e.startTime+e.duration
}
)),d=Math.max.apply(Math,l),v={
interactionTarget:a(f),interactionTargetElement:f,interactionType:t.name.startsWith("key")?"keyboard":"pointer",interactionTime:t.startTime,nextPaintTime:d,processedEventEntries:c,longAnimationFrameEntries:s,inputDelay:r-t.startTime,processingDuration:o-r,presentationDelay:Math.max(d-o,0),loadState:i(t.startTime)
}
;
return Object.assign(e,{
attribution:v
...
var n=function(e){
var t={
timeToFirstByte:0,resourceLoadDelay:0,resourceLoadDuration:0,elementRenderDelay:e.value
}
;
if(e.entries.length){
var n=r();
if(n){
var i=n.activationStart||0,o=e.entries[e.entries.length-1],c=o.url&&performance.getEntriesByType("resource").filter(function(e){
return e.name===o.url
}
)[0],s=Math.max(0,n.responseStart-i),u=Math.max(s,c?(c.requestStart||c.startTime)-i:0),f=Math.max(u,c?c.responseEnd-i:0),l=Math.max(f,o.startTime-i);
t={
element:a(o.element),timeToFirstByte:s,resourceLoadDelay:u-s,resourceLoadDuration:f-u,elementRenderDelay:l-f,navigationEntry:n,lcpEntry:o
}
...
var n=function(e){
var t={
waitingDuration:0,cacheDuration:0,dnsDuration:0,connectionDuration:0,requestDuration:0
}
;
if(e.entries.length){
var n=e.entries[0],r=n.activationStart||0,i=Math.max((n.workerStart||n.fetchStart)-r,0),o=Math.max(n.domainLookupStart-r,0),a=Math.max(n.connectStart-r,0),c=Math.max(n.connectEnd-r,0);
t={
waitingDuration:i,cacheDuration:o-i,dnsDuration:a-o,connectionDuration:c-a,requestDuration:e.value-c,navigationEntry:n
}
...
var o=i||"/cdn-cgi/rum?".concat(e),a=!0;
...
t.st=1;
var s=JSON.stringify(t),u=navigator.sendBeacon&&navigator.sendBeacon.bind(navigator);
...
),t.FetchPriority=t.EventType=void 0,function(e){
...
for(var r="ffffffff-ffff-ffff-ffff-ffffffffffff",i="00000000-0000-0000-0000-000000000000",o=/^(?:[0-9a-f]{
8
}
-[0-9a-f]{
4
...
|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i,a=function(e){
...
,s=[],u=0;
u<256;
++u)s.push((u+256).toString(16).slice(1));
function f(e,t){
...
for(var t=new Uint32Array(T(8*e.length)).fill(0),n=0;
n<e.length;
n++)t[n>>2]|=(255&e[n])<<n%4*8;
return t
}
(e),n=function(e,t){
var n=new Uint32Array(T(t)).fill(0);
n.set(e),n[t>>5]|=128<<t%32,n[n.length-1]=t,e=n;
for(var r=1732584193,i=-271733879,o=-1732584194,a=271733878,c=0;
c<e.length;
c+=16){
var s=r,u=i,f=o,l=a;
...
(t,8*e.length);
return function(e){
for(var t=new Uint8Array(4*e.length),n=0;
n<4*e.length;
n++)t[n]=e[n>>2]>>>n%4*8&255;
return t
}
(n)
}
,D="6ba7b810-9dad-11d1-80b4-00c04fd430c8",I="6ba7b811-9dad-11d1-80b4-00c04fd430c8";
function A(e,t,n,r,i,o){
var a="string"==typeof n?function(e){
e=unescape(encodeURIComponent(e));
for(var t=new Uint8Array(e.length),n=0;
n<e.length;
++n)t[n]=e.charCodeAt(n);
return t
}
(n):n,s="string"==typeof r?c(r):r;
...
var r,i,o,a=null!==(o=null!==(r=(e=e||{

}
).random)&&void 0!==r?r:null===(i=e.rng)||void 0===i?void 0:i.call(e))&&void 0!==o?o:p();
...
var _=function(e){
var t=[1518500249,1859775393,2400959708,3395469782],n=[1732584193,4023233417,2562383102,271733878,3285377520],r=new Uint8Array(e.length+1);
r.set(e),r[e.length]=128;
for(var i=(e=r).length/4+2,o=Math.ceil(i/16),a=new Array(o),c=0;
c<o;
++c){
for(var s=new Uint32Array(16),u=0;
u<16;
++u)s[u]=e[64*c+4*u]<<24|e[64*c+4*u+1]<<16|e[64*c+4*u+2]<<8|e[64*c+4*u+3];
a[c]=s
}
for(a[o-1][14]=8*(e.length-1)/Math.pow(2,32),a[o-1][14]=Math.floor(a[o-1][14]),a[o-1][15]=8*(e.length-1)&4294967295,c=0;
c<o;
++c){
for(var f=new Uint32Array(80),l=0;
l<16;
++l)f[l]=a[c][l];
for(l=16;
l<80;
++l)f[l]=k(f[l-3]^f[l-8]^f[l-14]^f[l-16],1);
var d=n[0],v=n[1],p=n[2],m=n[3],g=n[4];
for(l=0;
l<80;
++l){
var h=Math.floor(l/20),y=k(d,5)+B(h,v,p,m)+g+t[h]+f[l]>>>0;
...
var i=n(696),o=n(323),a=n(173),c=n(791),s=n(674);
!function(){
function e(e){
var t="";
...
!function(){
var t,n,u=window.performance||window.webkitPerformance||window.msPerformance||window.mozPerformance,f="data-cf-beacon",l=document.currentScript||("function"==typeof document.querySelector?document.querySelector("script[".concat(f,"]")):void 0),d=(0,c.v4)(),v=[],p=window.__cfBeacon?window.__cfBeacon:{
...
var h=new URLSearchParams(g.replace(/^[^\?]+\??/,"")),y=h.get("token");
y&&(p.token=y);
var T=h.get("spa");
p.spa=null===T||"true"===T
}
...
var L=p&&(void 0===p.spa||!0===p.spa),P=p.send&&p.send.to?p.send.to:void 0===p.version?"https://cloudflareinsights.com/cdn-cgi/rum":null,C=function(n){
var r=function(n){
...
,resources:[],referrer:(r=document.referrer||"",o=v[v.length-1],L&&w&&o?o.url:r),eventType:i.EventType.Load,firstPaint:0,firstContentfulPaint:0,startTime:R(),versions:{
fl:p?p.version:"",js:"2026.5.0",timings:1
}
,pageloadId:d,location:f,nt:b,serverTimings:M()
}
;
if(null==t){
...
,l.versions.timings=2,l.dt=m[0].deliveryType,delete l.timings;
var g=m[0];
...
(n);
r&&p&&(r.resources=[],p&&((0,o.sendObjectBeacon)("",r,function(){

}
,!1,P),void 0!==p.forward&&void 0!==p.forward.url&&(0,o.sendObjectBeacon)("",r,function(){
...
,D=function(){
var t=function(){
var t=u.getEntriesByType("navigation")[0],r="";
try{
...
,pageloadId:d,location:e(),landingPath:r,startTime:R(),nt:b,serverTimings:M()
}
;
...
t?t.then(C):C(),w={
id:d,url:e(),ts:(new Date).getTime(),triggered:!0
}
...
,U=function(e){
v.push({
id:d,url:e,ts:(new Date).getTime()
}
),v.length>3&&v.shift()
}
;
...
t<n.length;
t++)for(var r=n[t],i=0,o=u.getEntriesByType(r);
i<o.length;
i++){
var a=o[i],c=a.name,s=a.serverTiming;
if(s){
if("resource"===r){
...
g<h.length;
g++){
var y=h[g],T=y.name,w=y.description,b=y.duration;
if(p.serverTiming.name&&p.serverTiming.name[T])try{
var S=new URL(c);
e.push({
location:"resource"===r?"".concat(S.origin).concat(S.pathname):void 0,name:T,dur:b,desc:w
}
)
}
catch(e){
...
function B(e){
if("function"==typeof u.getEntriesByType){
var t=u.getEntriesByType("navigation"),n={
...
,t&&t[0]&&(t[0].nextHopProtocol&&(n.nextHopProtocol=t[0].nextHopProtocol),t[0].transferSize&&(n.transferSize=t[0].transferSize),t[0].decodedBodySize&&(n.decodedBodySize=t[0].decodedBodySize),e.dt=t[0].deliveryType),(0,s.buildTimingsObject)(n,e.timingsV2,s.timingsV2TargetKeys)
}
